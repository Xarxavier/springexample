...
@Entity
@Table(name = "leadcontrollaboral", schema = "leads", catalog = "")
public class Entity_Leadcontrollaboral {
    ...
    public String getConocio() {
        return conocio;
    }

    public void setConocio(String conocio) {
        this.conocio = conocio;
    }
    ...
    public boolean equals(Object o) {
        ...
        Entity_Leadcontrollaboral that = (Entity_Leadcontrollaboral) o;
        ...
        if (empleados != null ? !empleados.equals(that.empleados) : that.empleados != null) return false;
        if (conocio != null ? !conocio.equals(that.conocio) : that.conocio != null) return false;
        if (centros != null ? !centros.equals(that.centros) : that.centros != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (conocio != null ? conocio.hashCode() : 0);
        result = 31 * result + (centros != null ? centros.hashCode() : 0);
